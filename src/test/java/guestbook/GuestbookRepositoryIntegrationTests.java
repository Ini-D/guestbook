...
class GuestbookRepositoryIntegrationTests {
	...
	void persistsGuestbookEntry() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!","force@starwars.com"));
	...
	void findsGuestbookEntryByAuthorName() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!","force4free@porn.com"));
