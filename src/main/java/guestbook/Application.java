...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "first!!!","h4xx0r@puschelhase.com"), //
					new GuestbookEntry("Arni", "Hasta la vista, baby","trash@pentagon.com"), //
					new GuestbookEntry("Duke Nukem", "It's time to kick ass and chew bubble gum. And I'm all out of gum.","bloodbath@massacre.org"), //
					new GuestbookEntry("Gump1337",
							"Mama always said life was like a box of chocolates. You never know what you're gonna get.","dumbass@rich.com")) //
